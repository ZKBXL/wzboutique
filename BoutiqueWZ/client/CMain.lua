...
local mainMenu = RageUI.CreateMenu("", "Boutique")
...
local itemMenu = RageUI.CreateSubMenu(mainMenu, "", "")
...
Citizen.CreateThread(function()
    ...
    while (true) do
        ...
        RageUI.IsVisible(mainMenu, function()
            ...
            RageUI.Button('Vos points Boutique :', "Les achats sur la boutique vous permet de soutenir le serveur est bien plus encore.", { RightLabel = points }, true, {
